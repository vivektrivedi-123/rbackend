 ...
 */
router.get("/api/v1/stageData/:id", auth, isValid, stageDataController.getStageDataById);
/**
 * @swagger
 * tags:
 *  name: StageData
...
//patch
router.patch("/api/v1/stageData/:id", auth, isValid, stageDataController.patchStageData);
