...
const locationSchema = new mongoose.Schema(
  {
    ...
    location_name: { type: String, required: true , min: 5, max: 80 },
    location_address: { type: String, required: true, min: 5, max: 80  },
    location_city: { type: String, required: true, min: 3, max: 30  },
